      ...
      <div className='max-w-full mx-auto flex overflow-hidden'>
        {
          data.map(slider => {
            return(
              <section className='min-w-full min-h-screen bg-no-repeat bg-cover relative'>
                      ...
                      <div className="w-full h-full text-white flex justify-center flex-col items-center">
                        ...
                        { slider?.boton &&  
                          <form className='flex flex-col w-full md:w-2/4 md:flex-row mt-5 gap-2 items-stretch'>
                            <input type="text" className='p-2 border-2 border-[#0076DF] rounded-lg w-full md:w-3/4' placeholder='Dirección de correo electrónico' />
                            <button className='rounded-lg bg-[#0076DF] text-sm w-full p-2 md:w-1/4 font-semibold text-white'>Contratar Ahora</button>
                          </form>
                        }
                      </div>
                    </div>
